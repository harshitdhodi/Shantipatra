...
import StrappingPoints from "../StrappingPoint";
import BOPPTapes from "../BOPP";
        ...
        Cell: ({ value }) => (
          value ? (
            <div className="flex gap-4">
              <a className="text-[#df950d] hover:text-green-700 transition" href={`/api/product/download/${value}`}>
                <FaDownload size={20} />
              </a>
