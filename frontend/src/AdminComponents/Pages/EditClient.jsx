...
/api/client/getClientsById?id=${id}`, { withCredentials: true });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`/api/client/updateClients?id=${id}`, formData, {
        headers: {
  ...
  const handleDeleteInitialPhoto = (e, photoFilename, index) => {
    e.preventDefault();
    axios.delete(`
/api/client/${id}/image/${photoFilename}/${index}`, { withCredentials: true })
      .then(response => {
