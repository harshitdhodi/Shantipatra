  ...
  return (
    <div className="min-h-screen flex flex-col items-center  p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full max-w-5xl mt-8">
        <div className="bg-[#df950d] text-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center">
          ...
          <button className="bg-white text-[#df950d] px-4 py-2 rounded hover:bg-green-200">
            <a href={`
